...
-- compress a RazorEdit by 0.5 from the right
...
if razor_edit_index>-1 then
  dif=(end_position-start_position)/2
  retval = ultraschall.RazorEdit_Set_Track(MediaTrack, razor_edit_index, start_position, start_position+dif)

  reaper.UpdateArrange()
end  
reaper.PreventUIRefresh(1)
reaper.Undo_EndBlock("Compress RazorEdit by 0.5 on the right", -1)
