...
-- enhance a RazorEdit by two to the right
...
if razor_edit_index>-1 then
  ...
  retval = ultraschall.RazorEdit_Set_Track(MediaTrack, razor_edit_index, start_position, end_position+dif)

  reaper.UpdateArrange()
end  
reaper.PreventUIRefresh(1)
reaper.Undo_EndBlock("Enhance RazorEdit by 2 to the right", -1)
