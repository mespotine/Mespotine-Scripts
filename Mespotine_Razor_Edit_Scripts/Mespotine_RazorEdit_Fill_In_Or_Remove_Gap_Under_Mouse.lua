...
-- remove the RazorEdit under mouse
...
if razor_edit_index==-1 then
  if envelope==nil then 
    altered_razor_edit_string = ultraschall.RazorEdit_Add_Track(track, start_position, end_position)
  else
    altered_razor_edit_string = ultraschall.RazorEdit_Add_Envelope(envelope, start_position, end_position)
  end
end
