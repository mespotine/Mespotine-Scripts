...
-- nudges the RazorEdit under mouse 1 minute to the right
...
if envelope==nil then 
  retval = ultraschall.RazorEdit_Nudge_Track(track, 60, razor_edit_index)
else
  retval = ultraschall.RazorEdit_Nudge_Envelope(envelope, 60, razor_edit_index)
end

reaper.Undo_EndBlock("Nudge Razor Edit 1 minute right", -1)
