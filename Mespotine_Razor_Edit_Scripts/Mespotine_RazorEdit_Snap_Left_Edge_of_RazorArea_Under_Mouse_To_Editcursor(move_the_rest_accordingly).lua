...
-- snap RazorEdit-start to editcursor at mouse position
...
delta=editcursor-start_position
...
reaper.Undo_EndBlock("Snap left edge of RazorArea To Edit Cursor(Move all RE accordingly)", -1)
