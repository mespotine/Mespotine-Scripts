...
if razor_edit_index>-1 then
  ...
  retval = ultraschall.RazorEdit_Set_Track(MediaTrack, razor_edit_index, start_position+dif, end_position)

  reaper.UpdateArrange()
end  
reaper.PreventUIRefresh(1)
reaper.Undo_EndBlock("Compress RazorEdit by 0.5 on the left", -1)
