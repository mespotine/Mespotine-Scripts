...
-- enhance a RazorEdit to the item's next transient at mouse position
...
if item~=nil and razor_edit_index>-1 then
  ...
  reaper.SetEditCurPos(end_position, false, false)
  reaper.Main_OnCommand(40375, 0)
  local editcursor_new=reaper.GetCursorPosition()
  retval = ultraschall.RazorEdit_Set_Track(MediaTrack, razor_edit_index, start_position, editcursor_new)
