...
-- snaps a RazorEdit-end to an item's end at mouse position
...
if item~=nil then
  ...
  if Envelope==nil then
    ...
    retval = ultraschall.RazorEdit_Set_Track(MediaTrack, razor_edit_index, start_position, stop)
  else
    --altered_razor_edit_string = ultraschall.RazorEdit_Add_Envelope(Envelope, start, stop)
    retval = ultraschall.RazorEdit_Set_Envelope(Envelope, razor_edit_index, start_position, stop)
  end
end
