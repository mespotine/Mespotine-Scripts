...
-- nudges the RazorEdit under mouse 10 seconds to the left
...
if envelope==nil then 
  retval = ultraschall.RazorEdit_Nudge_Track(track, -10, razor_edit_index)
else
  retval = ultraschall.RazorEdit_Nudge_Envelope(envelope, -10, razor_edit_index)
end

reaper.Undo_EndBlock("Nudge Razor Edit 10 seconds left", -1)
